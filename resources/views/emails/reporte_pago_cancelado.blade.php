...
<head>
    <title>Reporte de Pago Cancelado</title>
</head>
...
<body style="font-family: Arial, sans-serif; background-color: #f4f6f9; padding: 20px;">
    <div
        ...
        <h2 style="color: #dc3545; text-align: center;">¡Reporte de Pago Cancelado!</h2>
        <p>Hola, {{ $nombre }}</p>
        @if ($id_orden)
            <p>Te informamos que el reporte de pago de la orden #{{ $id_orden }} ha sido cancelado.</p>
        @else
            <p>Te informamos que el reporte de pago del plan de membresia {{ $nombre_plan_membresia }} ha sido cancelado.
            </p>
        @endif
        @if ($observaciones)
